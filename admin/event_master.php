...
if(empty($err)){
	 ...
	 $sql="insert into $event_registration_table (id,Event_name,Remarks,stamp)values('','$event_name','$movie_remarks',now())";
	
	 
	  $sql_event=mysql_query("insert into team_event_name(event,event_remarks)values('$event','$movie_remarks')");
