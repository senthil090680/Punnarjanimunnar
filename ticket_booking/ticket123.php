...
<?php
echo $expiry_ticket_123 =$_GET['expiry_ticket_123'];
echo $expiry =$_GET['expiry_ticket_123'];
echo $ticket_123 =$_GET['ticket_123'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_123'];
...
$rate_123=$_GET['Class_three_rate'];
echo $rate_123;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_123='$rate_123'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_123 ='$expiry_ticket_123'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_123 ='$ticket_123'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
