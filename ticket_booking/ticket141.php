...
<?php
echo $expiry_ticket_141 =$_GET['expiry_ticket_141'];
echo $expiry =$_GET['expiry_ticket_141'];
echo $ticket_141 =$_GET['ticket_141'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_141'];
...
$rate_141=$_GET['Class_three_rate'];
echo $rate_141;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_141='$rate_141'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_141 ='$expiry_ticket_141'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_141 ='$ticket_141'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
