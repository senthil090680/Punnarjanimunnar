...
<?php
echo $expiry_ticket_155 =$_GET['expiry_ticket_155'];
echo $expiry =$_GET['expiry_ticket_155'];
echo $ticket_155 =$_GET['ticket_155'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_155'];
...
$rate_155=$_GET['Class_three_rate'];
echo $rate_155;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_155='$rate_155'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_155 ='$expiry_ticket_155'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_155 ='$ticket_155'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
