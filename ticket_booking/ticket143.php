...
<?php
echo $expiry_ticket_143 =$_GET['expiry_ticket_143'];
echo $expiry =$_GET['expiry_ticket_143'];
echo $ticket_143 =$_GET['ticket_143'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_143'];
...
$rate_143=$_GET['Class_three_rate'];
echo $rate_143;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_143='$rate_143'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_143 ='$expiry_ticket_143'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_143 ='$ticket_143'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
