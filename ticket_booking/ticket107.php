...
<?php
echo $expiry_ticket_107 =$_GET['expiry_ticket_107'];
echo $expiry =$_GET['expiry_ticket_107'];
echo $ticket_107 =$_GET['ticket_107'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_107'];
...
$rate_107=$_GET['Class_three_rate'];
echo $rate_107;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_107='$rate_107'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_107 ='$expiry_ticket_107'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_107 ='$ticket_107'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
