...
<?php
echo $expiry_ticket_149 =$_GET['expiry_ticket_149'];
echo $expiry =$_GET['expiry_ticket_149'];
echo $ticket_149 =$_GET['ticket_149'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_149'];
...
$rate_149=$_GET['Class_three_rate'];
echo $rate_149;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_149='$rate_149'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_149 ='$expiry_ticket_149'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_149 ='$ticket_149'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
