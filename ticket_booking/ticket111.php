...
<?php
echo $expiry_ticket_111 =$_GET['expiry_ticket_111'];
echo $expiry =$_GET['expiry_ticket_111'];
echo $ticket_111 =$_GET['ticket_111'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_111'];
...
$rate_111=$_GET['Class_three_rate'];
echo $rate_111;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_111='$rate_111'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_111 ='$expiry_ticket_111'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_111 ='$ticket_111'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
