...
<?php
echo $expiry_ticket_152 =$_GET['expiry_ticket_152'];
echo $expiry =$_GET['expiry_ticket_152'];
echo $ticket_152 =$_GET['ticket_152'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_152'];
...
$rate_152=$_GET['Class_three_rate'];
echo $rate_152;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_152='$rate_152'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_152 ='$expiry_ticket_152'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_152 ='$ticket_152'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
