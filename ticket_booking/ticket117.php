...
<?php
echo $expiry_ticket_117 =$_GET['expiry_ticket_117'];
echo $expiry =$_GET['expiry_ticket_117'];
echo $ticket_117 =$_GET['ticket_117'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_117'];
...
echo $rate_117;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_117='$rate_117'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_117 ='$expiry_ticket_117'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_117 ='$ticket_117'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
