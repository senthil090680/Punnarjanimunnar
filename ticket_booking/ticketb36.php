...
<?php
echo $expiry_ticket_b36 =$_GET['expiry_ticket_b36'];
echo $expiry =$_GET['expiry_ticket_b36'];
echo $ticket_b36 =$_GET['ticket_b36'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_b36'];
...
$rate_b36=$_GET['Class_three_rate'];
echo $rate_b36;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_b36='$rate_b36'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_b36 ='$expiry_ticket_b36'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_b36 ='$ticket_b36'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
