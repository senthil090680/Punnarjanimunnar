...
<?php
echo $expiry_ticket_f16 =$_GET['expiry_ticket_f16'];
echo $expiry =$_GET['expiry_ticket_f16'];
echo $ticket_f16 =$_GET['ticket_f16'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_f16'];
...
$rate_f16=$_GET['Class_three_rate'];
echo $rate_f16;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_f16='$rate_f16'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_f16 ='$expiry_ticket_f16'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_f16 ='$ticket_f16'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
