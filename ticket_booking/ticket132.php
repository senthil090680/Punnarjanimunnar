...
<?php
echo $expiry_ticket_132 =$_GET['expiry_ticket_132'];
echo $expiry =$_GET['expiry_ticket_132'];
echo $ticket_132 =$_GET['ticket_132'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_132'];
...
$rate_132=$_GET['Class_three_rate'];
echo $rate_132;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_132='$rate_132'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_132 ='$expiry_ticket_132'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_132 ='$ticket_132'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
