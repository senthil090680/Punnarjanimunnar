...
<?php
echo $expiry_ticket_114 =$_GET['expiry_ticket_114'];
echo $expiry =$_GET['expiry_ticket_114'];
echo $ticket_114 =$_GET['ticket_114'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_114'];
...
$rate_114=$_GET['Class_three_rate'];
echo $rate_114;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_114='$rate_114'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_114 ='$expiry_ticket_114'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_114 ='$ticket_114'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
