...
<?php
echo $expiry_ticket_d41 =$_GET['expiry_ticket_d41'];
echo $expiry =$_GET['expiry_ticket_d41'];
echo $ticket_d41 =$_GET['ticket_d41'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_d41'];
...
$rate_d41=$_GET['Class_three_rate'];
echo $rate_d41;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_d41='$rate_d41'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_d41 ='$expiry_ticket_d41'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_d41 ='$ticket_d41'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
