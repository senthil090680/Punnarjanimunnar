...
<?php
echo $expiry_ticket_158 =$_GET['expiry_ticket_158'];
echo $expiry =$_GET['expiry_ticket_158'];
echo $ticket_158 =$_GET['ticket_158'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_158'];
...
$rate_158=$_GET['Class_three_rate'];
echo $rate_158;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_158='$rate_158'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_158 ='$expiry_ticket_158'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_158 ='$ticket_158'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
