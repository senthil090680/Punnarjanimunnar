...
<?php
echo $expiry_ticket_d33 =$_GET['expiry_ticket_d33'];
echo $expiry =$_GET['expiry_ticket_d33'];
echo $ticket_d33 =$_GET['ticket_d33'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_d33'];
...
$rate_d33=$_GET['Class_three_rate'];
echo $rate_d33;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_d33='$rate_d33'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_d33 ='$expiry_ticket_d33'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_d33 ='$ticket_d33'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
