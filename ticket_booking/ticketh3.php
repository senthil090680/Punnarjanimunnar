...
<?php
echo $expiry_ticket_h3 =$_GET['expiry_ticket_h3'];
echo $expiry =$_GET['expiry_ticket_h3'];
echo $ticket_h3 =$_GET['ticket_h3'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_h3'];
...
$rate_h3=$_GET['Class_three_rate'];
echo $rate_h3;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_h3='$rate_h3'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_h3 ='$expiry_ticket_h3'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_h3 ='$ticket_h3'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
