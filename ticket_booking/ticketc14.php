...
<?php
echo $expiry_ticket_c14 =$_GET['expiry_ticket_c14'];
echo $expiry =$_GET['expiry_ticket_c14'];
echo $ticket_c14 =$_GET['ticket_c14'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_c14'];
...
$rate_c14=$_GET['Class_three_rate'];
echo $rate_c14;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_c14='$rate_c14'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_c14 ='$expiry_ticket_c14'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_c14 ='$ticket_c14'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
