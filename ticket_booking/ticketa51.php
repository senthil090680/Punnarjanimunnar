...
<?php
echo $expiry_ticket_a51 =$_GET['expiry_ticket_a51'];
echo $expiry =$_GET['expiry_ticket_a51'];
echo $ticket_a51 =$_GET['ticket_a51'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_a51'];
...
$rate_a51=$_GET['Class_three_rate'];
echo $rate_a51;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_a51='$rate_a51'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_a51 ='$expiry_ticket_a51'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_a51 ='$ticket_a51'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
