...
<?php
echo $expiry_ticket_b45 =$_GET['expiry_ticket_b45'];
echo $expiry =$_GET['expiry_ticket_b45'];
echo $ticket_b45 =$_GET['ticket_b45'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_b45'];
...
$rate_b45=$_GET['Class_three_rate'];
echo $rate_b45;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_b45='$rate_b45'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_b45 ='$expiry_ticket_b45'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_b45 ='$ticket_b45'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
