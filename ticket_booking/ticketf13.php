...
<?php
echo $expiry_ticket_f13 =$_GET['expiry_ticket_f13'];
echo $expiry =$_GET['expiry_ticket_f13'];
echo $ticket_f13 =$_GET['ticket_f13'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_f13'];
...
$rate_f13=$_GET['Class_three_rate'];
echo $rate_f13;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_f13='$rate_f13'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_f13 ='$expiry_ticket_f13'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_f13 ='$ticket_f13'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
