...
<?php
echo $expiry_ticket_s3 =$_GET['expiry_ticket_s3'];
echo $expiry =$_GET['expiry_ticket_s3'];
echo $ticket_s3 =$_GET['ticket_s3'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_s3'];
...
$rate_s3=$_GET['Class_three_rate'];
echo $rate_s3;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_s3='$rate_s3'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_s3 ='$expiry_ticket_s3'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_s3 ='$ticket_s3'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
