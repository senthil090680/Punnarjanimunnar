...
<?php
echo $expiry_ticket_b38 =$_GET['expiry_ticket_b38'];
echo $expiry =$_GET['expiry_ticket_b38'];
echo $ticket_b38 =$_GET['ticket_b38'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_b38'];
...
$rate_b38=$_GET['Class_three_rate'];
echo $rate_b38;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_b38='$rate_b38'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_b38 ='$expiry_ticket_b38'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_b38 ='$ticket_b38'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
