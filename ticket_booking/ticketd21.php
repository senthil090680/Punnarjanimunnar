...
<?php
echo $expiry_ticket_d21 =$_GET['expiry_ticket_d21'];
echo $expiry =$_GET['expiry_ticket_d21'];
echo $ticket_d21 =$_GET['ticket_d21'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_d21'];
...
$rate_d21=$_GET['Class_three_rate'];
echo $rate_d21;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_d21='$rate_d21'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_d21 ='$expiry_ticket_d21'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_d21 ='$ticket_d21'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
