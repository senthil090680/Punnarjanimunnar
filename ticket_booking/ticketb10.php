...
<?php
echo $expiry_ticket_b10 =$_GET['expiry_ticket_b10'];
echo $expiry =$_GET['expiry_ticket_b10'];
echo $ticket_b10 =$_GET['ticket_b10'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_b10'];
...
$rate_b10=$_GET['Class_three_rate'];
echo $rate_b10;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_b10='$rate_b10'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_b10 ='$expiry_ticket_b10'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_b10 ='$ticket_b10'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
