...
<?php
echo $expiry_ticket_b59 =$_GET['expiry_ticket_b59'];
echo $expiry =$_GET['expiry_ticket_b59'];
echo $ticket_b59 =$_GET['ticket_b59'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_b59'];
...
$rate_b59=$_GET['Class_three_rate'];
echo $rate_b59;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_b59='$rate_b59'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_b59 ='$expiry_ticket_b59'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_b59 ='$ticket_b59'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
