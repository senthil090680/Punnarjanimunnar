...
<?php
echo $expiry_ticket_b35 =$_GET['expiry_ticket_b35'];
echo $expiry =$_GET['expiry_ticket_b35'];
echo $ticket_b35 =$_GET['ticket_b35'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_b35'];
...
$rate_b35=$_GET['Class_three_rate'];
echo $rate_b35;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_b35='$rate_b35'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_b35 ='$expiry_ticket_b35'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_b35 ='$ticket_b35'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
