...
<?php
echo $expiry_ticket_108 =$_GET['expiry_ticket_108'];
echo $expiry =$_GET['expiry_ticket_108'];
echo $ticket_108 =$_GET['ticket_108'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_108'];
...
$rate_108=$_GET['Class_three_rate'];
echo $rate_108;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_108='$rate_108'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_108 ='$expiry_ticket_108'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_108 ='$ticket_108'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
