...
<?php
echo $expiry_ticket_e12 =$_GET['expiry_ticket_e12'];
echo $expiry =$_GET['expiry_ticket_e12'];
echo $ticket_e12 =$_GET['ticket_e12'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_e12'];
...
$rate_e12=$_GET['Class_three_rate'];
echo $rate_e12;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_e12='$rate_e12'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_e12 ='$expiry_ticket_e12'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_e12 ='$ticket_e12'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
