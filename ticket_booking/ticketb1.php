...
<?php
echo $expiry_ticket_b1 =$_GET['expiry_ticket_b1'];
echo $expiry =$_GET['expiry_ticket_b1'];
echo $ticket_b1 =$_GET['ticket_b1'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_b1'];
...
$rate_b1=$_GET['Class_three_rate'];
echo $rate_b1;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_b1='$rate_b1'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_b1 ='$expiry_ticket_b1'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_b1 ='$ticket_b1'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
