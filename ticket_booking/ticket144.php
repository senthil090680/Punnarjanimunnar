...
<?php
echo $expiry_ticket_144 =$_GET['expiry_ticket_144'];
echo $expiry =$_GET['expiry_ticket_144'];
echo $ticket_144 =$_GET['ticket_144'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_144'];
...
$rate_144=$_GET['Class_three_rate'];
echo $rate_144;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_144='$rate_144'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_144 ='$expiry_ticket_144'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_144 ='$ticket_144'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
