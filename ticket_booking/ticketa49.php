...
<?php
echo $expiry_ticket_a49 =$_GET['expiry_ticket_a49'];
echo $expiry =$_GET['expiry_ticket_a49'];
echo $ticket_a49 =$_GET['ticket_a49'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_a49'];
...
$rate_a49=$_GET['Class_three_rate'];
echo $rate_a49;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_a49='$rate_a49'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_a49 ='$expiry_ticket_a49'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_a49 ='$ticket_a49'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
