...
<?php
echo $expiry_ticket_a54 =$_GET['expiry_ticket_a54'];
echo $expiry =$_GET['expiry_ticket_a54'];
echo $ticket_a54 =$_GET['ticket_a54'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_a54'];
...
$rate_a54=$_GET['Class_three_rate'];
echo $rate_a54;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_a54='$rate_a54'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_a54 ='$expiry_ticket_a54'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_a54 ='$ticket_a54'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
