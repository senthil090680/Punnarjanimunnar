...
<?php
echo $expiry_ticket_c49 =$_GET['expiry_ticket_c49'];
echo $expiry =$_GET['expiry_ticket_c49'];
echo $ticket_c49 =$_GET['ticket_c49'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_c49'];
...
$rate_c49=$_GET['Class_three_rate'];
echo $rate_c49;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_c49='$rate_c49'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_c49 ='$expiry_ticket_c49'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_c49 ='$ticket_c49'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
