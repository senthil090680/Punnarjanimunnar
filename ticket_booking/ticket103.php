...
<?php
echo $expiry_ticket_103 =$_GET['expiry_ticket_103'];
echo $expiry =$_GET['expiry_ticket_103'];
echo $ticket_103 =$_GET['ticket_103'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_103'];
...
$rate_103=$_GET['Class_three_rate'];
echo $rate_103;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_103='$rate_103'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_103 ='$expiry_ticket_103'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_103 ='$ticket_103'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
