...
<?php
echo $expiry_ticket_e5 =$_GET['expiry_ticket_e5'];
echo $expiry =$_GET['expiry_ticket_e5'];
echo $ticket_e5 =$_GET['ticket_e5'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_e5'];
...
$rate_e5=$_GET['Class_three_rate'];
echo $rate_e5;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_e5='$rate_e5'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_e5 ='$expiry_ticket_e5'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_e5 ='$ticket_e5'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
