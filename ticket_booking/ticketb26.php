...
<?php
echo $expiry_ticket_b26 =$_GET['expiry_ticket_b26'];
echo $expiry =$_GET['expiry_ticket_b26'];
echo $ticket_b26 =$_GET['ticket_b26'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_b26'];
...
$rate_b26=$_GET['Class_three_rate'];
echo $rate_b26;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_b26='$rate_b26'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_b26 ='$expiry_ticket_b26'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_b26 ='$ticket_b26'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
