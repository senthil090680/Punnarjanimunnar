...
<?php
echo $expiry_ticket_129 =$_GET['expiry_ticket_129'];
echo $expiry =$_GET['expiry_ticket_129'];
echo $ticket_129 =$_GET['ticket_129'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_129'];
...
$rate_129=$_GET['Class_three_rate'];
echo $rate_129;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_129='$rate_129'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_129 ='$expiry_ticket_129'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_129 ='$ticket_129'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
