...
<?php
echo $expiry_ticket_b40 =$_GET['expiry_ticket_b40'];
echo $expiry =$_GET['expiry_ticket_b40'];
echo $ticket_b40 =$_GET['ticket_b40'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_b40'];
...
$rate_b40=$_GET['Class_three_rate'];
echo $rate_b40;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_b40='$rate_b40'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_b40 ='$expiry_ticket_b40'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_b40 ='$ticket_b40'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
