...
<?php
echo $expiry_ticket_c28 =$_GET['expiry_ticket_c28'];
echo $expiry =$_GET['expiry_ticket_c28'];
echo $ticket_c28 =$_GET['ticket_c28'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_c28'];
...
$rate_c28=$_GET['Class_three_rate'];
echo $rate_c28;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_c28='$rate_c28'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_c28 ='$expiry_ticket_c28'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_c28 ='$ticket_c28'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
