...
<?php
echo $expiry_ticket_110 =$_GET['expiry_ticket_110'];
echo $expiry =$_GET['expiry_ticket_110'];
echo $ticket_110 =$_GET['ticket_110'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_110'];
...
$rate_110=$_GET['Class_three_rate'];
echo $rate_110;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_110='$rate_110'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_110 ='$expiry_ticket_110'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_110 ='$ticket_110'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
