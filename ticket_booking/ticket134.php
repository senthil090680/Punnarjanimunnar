...
<?php
echo $expiry_ticket_134 =$_GET['expiry_ticket_134'];
echo $expiry =$_GET['expiry_ticket_134'];
echo $ticket_134 =$_GET['ticket_134'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_134'];
...
$rate_134=$_GET['Class_three_rate'];
echo $rate_134;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_134='$rate_134'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_134 ='$expiry_ticket_134'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_134 ='$ticket_134'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
