...
<?php
echo $expiry_ticket_a40 =$_GET['expiry_ticket_a40'];
echo $expiry =$_GET['expiry_ticket_a40'];
echo $ticket_a40 =$_GET['ticket_a40'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_a40'];
...
$rate_a40=$_GET['Class_three_rate'];
echo $rate_a40;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_a40='$rate_a40'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_a40 ='$expiry_ticket_a40'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_a40 ='$ticket_a40'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
