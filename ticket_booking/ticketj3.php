...
<?php
echo $expiry_ticket_j3 =$_GET['expiry_ticket_j3'];
echo $expiry =$_GET['expiry_ticket_j3'];
echo $ticket_j3 =$_GET['ticket_j3'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_j3'];
...
$rate_j3=$_GET['Class_three_rate'];
echo $rate_j3;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_j3='$rate_j3'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_j3 ='$expiry_ticket_j3'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_j3 ='$ticket_j3'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
