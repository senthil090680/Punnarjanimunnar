...
<?php
echo $expiry_ticket_a50 =$_GET['expiry_ticket_a50'];
echo $expiry =$_GET['expiry_ticket_a50'];
echo $ticket_a50 =$_GET['ticket_a50'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_a50'];
...
$rate_a50=$_GET['Class_three_rate'];
echo $rate_a50;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_a50='$rate_a50'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_a50 ='$expiry_ticket_a50'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_a50 ='$ticket_a50'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
