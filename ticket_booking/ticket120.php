...
<?php
echo $expiry_ticket_120 =$_GET['expiry_ticket_120'];
echo $expiry =$_GET['expiry_ticket_120'];
echo $ticket_120 =$_GET['ticket_120'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_120'];
...
$rate_120=$_GET['Class_three_rate'];
echo $rate_120;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_120='$rate_120'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_120 ='$expiry_ticket_120'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_120 ='$ticket_120'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
