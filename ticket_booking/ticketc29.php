...
<?php
echo $expiry_ticket_c29 =$_GET['expiry_ticket_c29'];
echo $expiry =$_GET['expiry_ticket_c29'];
echo $ticket_c29 =$_GET['ticket_c29'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_c29'];
...
$rate_c29=$_GET['Class_three_rate'];
echo $rate_c29;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_c29='$rate_c29'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_c29 ='$expiry_ticket_c29'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_c29 ='$ticket_c29'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
