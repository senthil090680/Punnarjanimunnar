...
<?php
echo $expiry_ticket_128 =$_GET['expiry_ticket_128'];
echo $expiry =$_GET['expiry_ticket_128'];
echo $ticket_128 =$_GET['ticket_128'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_128'];
...
$rate_128=$_GET['Class_three_rate'];
echo $rate_128;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_128='$rate_128'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_128 ='$expiry_ticket_128'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_128 ='$ticket_128'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
