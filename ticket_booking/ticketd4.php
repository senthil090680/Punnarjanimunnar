...
<?php
echo $expiry_ticket_d4 =$_GET['expiry_ticket_d4'];
echo $expiry =$_GET['expiry_ticket_d4'];
echo $ticket_d4 =$_GET['ticket_d4'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_d4'];
...
$rate_d4=$_GET['Class_three_rate'];
echo $rate_d4;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_d4='$rate_d4'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_d4 ='$expiry_ticket_d4'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_d4 ='$ticket_d4'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
