...
<?php
echo $expiry_ticket_u22 =$_GET['expiry_ticket_u22'];
echo $expiry =$_GET['expiry_ticket_u22'];
echo $ticket_u22 =$_GET['ticket_u22'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_u22'];
...
$rate_u22=$_GET['Class_three_rate'];
echo $rate_u22;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_u22='$rate_u22'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_u22 ='$expiry_ticket_u22'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_u22 ='$ticket_u22'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
