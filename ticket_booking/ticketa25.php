...
<?php
echo $expiry_ticket_a25 =$_GET['expiry_ticket_a25'];
echo $expiry =$_GET['expiry_ticket_a25'];
echo $ticket_a25 =$_GET['ticket_a25'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_a25'];
...
$rate_a25=$_GET['Class_three_rate'];
echo $rate_a25;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_a25='$rate_a25'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_a25 ='$expiry_ticket_a25'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_a25 ='$ticket_a25'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
