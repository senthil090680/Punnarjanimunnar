...
<?php
echo $expiry_ticket_122 =$_GET['expiry_ticket_122'];
echo $expiry =$_GET['expiry_ticket_122'];
echo $ticket_122 =$_GET['ticket_122'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_122'];
...
$rate_122=$_GET['Class_three_rate'];
echo $rate_122;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_122='$rate_122'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_122 ='$expiry_ticket_122'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_122 ='$ticket_122'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
