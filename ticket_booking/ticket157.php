...
<?php
echo $expiry_ticket_157 =$_GET['expiry_ticket_157'];
echo $expiry =$_GET['expiry_ticket_157'];
echo $ticket_157 =$_GET['ticket_157'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_157'];
...
$rate_157=$_GET['Class_three_rate'];
echo $rate_157;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_157='$rate_157'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_157 ='$expiry_ticket_157'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_157 ='$ticket_157'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
