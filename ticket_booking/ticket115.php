...
<?php
echo $expiry_ticket_115 =$_GET['expiry_ticket_115'];
echo $expiry =$_GET['expiry_ticket_115'];
echo $ticket_115 =$_GET['ticket_115'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_115'];
...
$rate_115=$_GET['Class_three_rate'];
echo $rate_115;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_115='$rate_115'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_115 ='$expiry_ticket_115'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_115 ='$ticket_115'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
