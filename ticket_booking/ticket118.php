...
<?php
echo $expiry_ticket_118 =$_GET['expiry_ticket_118'];
echo $expiry =$_GET['expiry_ticket_118'];
echo $ticket_118 =$_GET['ticket_118'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_118'];
...
$rate_118=$_GET['Class_three_rate'];
echo $rate_118;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_118='$rate_118'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_118 ='$expiry_ticket_118'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_118 ='$ticket_118'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
