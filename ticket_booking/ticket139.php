...
<?php
echo $expiry_ticket_139 =$_GET['expiry_ticket_139'];
echo $expiry =$_GET['expiry_ticket_139'];
echo $ticket_139 =$_GET['ticket_139'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_139'];
...
$rate_139=$_GET['Class_three_rate'];
echo $rate_139;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_139='$rate_139'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_139 ='$expiry_ticket_139'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_139 ='$ticket_139'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
