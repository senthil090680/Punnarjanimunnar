...
<?php
echo $expiry_ticket_u18 =$_GET['expiry_ticket_u18'];
echo $expiry =$_GET['expiry_ticket_u18'];
echo $ticket_u18 =$_GET['ticket_u18'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_u18'];
...
$rate_u18=$_GET['Class_three_rate'];
echo $rate_u18;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_u18='$rate_u18'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_u18 ='$expiry_ticket_u18'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_u18 ='$ticket_u18'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
