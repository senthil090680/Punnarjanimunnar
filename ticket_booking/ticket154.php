...
<?php
echo $expiry_ticket_154 =$_GET['expiry_ticket_154'];
echo $expiry =$_GET['expiry_ticket_154'];
echo $ticket_154 =$_GET['ticket_154'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_154'];
...
$rate_154=$_GET['Class_three_rate'];
echo $rate_154;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_154='$rate_154'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_154 ='$expiry_ticket_154'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_154 ='$ticket_154'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
