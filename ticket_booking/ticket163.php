...
<?php
echo $expiry_ticket_163 =$_GET['expiry_ticket_163'];
echo $expiry =$_GET['expiry_ticket_163'];
echo $ticket_163 =$_GET['ticket_163'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_163'];
...
$rate_163=$_GET['Class_three_rate'];
echo $rate_163;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_163='$rate_163'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_163 ='$expiry_ticket_163'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_163 ='$ticket_163'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
