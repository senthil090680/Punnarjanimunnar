...
<?php
echo $expiry_ticket_136 =$_GET['expiry_ticket_136'];
echo $expiry =$_GET['expiry_ticket_136'];
echo $ticket_136 =$_GET['ticket_136'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_136'];
...
$rate_136=$_GET['Class_three_rate'];
echo $rate_136;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_136='$rate_136'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_136 ='$expiry_ticket_136'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_136 ='$ticket_136'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
