...
<?php
echo $expiry_ticket_h6 =$_GET['expiry_ticket_h6'];
echo $expiry =$_GET['expiry_ticket_h6'];
echo $ticket_h6 =$_GET['ticket_h6'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_h6'];
...
$rate_h6=$_GET['Class_three_rate'];
echo $rate_h6;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_h6='$rate_h6'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_h6 ='$expiry_ticket_h6'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_h6 ='$ticket_h6'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
