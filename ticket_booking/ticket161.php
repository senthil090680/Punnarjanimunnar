...
<?php
echo $expiry_ticket_161 =$_GET['expiry_ticket_161'];
echo $expiry =$_GET['expiry_ticket_161'];
echo $ticket_161 =$_GET['ticket_161'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_161'];
...
$rate_161=$_GET['Class_three_rate'];
echo $rate_161;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_161='$rate_161'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_161 ='$expiry_ticket_161'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_161 ='$ticket_161'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
