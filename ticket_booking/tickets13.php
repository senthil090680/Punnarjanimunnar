...
<?php
echo $expiry_ticket_s13 =$_GET['expiry_ticket_s13'];
echo $expiry =$_GET['expiry_ticket_s13'];
echo $ticket_s13 =$_GET['ticket_s13'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_s13'];
...
$rate_s13=$_GET['Class_three_rate'];
echo $rate_s13;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_s13='$rate_s13'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_s13 ='$expiry_ticket_s13'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_s13 ='$ticket_s13'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
