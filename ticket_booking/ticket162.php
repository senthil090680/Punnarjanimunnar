...
<?php
echo $expiry_ticket_162 =$_GET['expiry_ticket_162'];
echo $expiry =$_GET['expiry_ticket_162'];
echo $ticket_162 =$_GET['ticket_162'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_162'];
...
$rate_162=$_GET['Class_three_rate'];
echo $rate_162;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_162='$rate_162'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_162 ='$expiry_ticket_162'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_162 ='$ticket_162'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
