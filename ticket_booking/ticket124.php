...
<?php
echo $expiry_ticket_124 =$_GET['expiry_ticket_124'];
echo $expiry =$_GET['expiry_ticket_124'];
echo $ticket_124 =$_GET['ticket_124'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_124'];
...
$rate_124=$_GET['Class_three_rate'];
echo $rate_124;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_124='$rate_124'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_124 ='$expiry_ticket_124'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_124 ='$ticket_124'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
