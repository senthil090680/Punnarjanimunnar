...
<?php
echo $expiry_ticket_133 =$_GET['expiry_ticket_133'];
echo $expiry =$_GET['expiry_ticket_133'];
echo $ticket_133 =$_GET['ticket_133'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_133'];
...
$rate_133=$_GET['Class_three_rate'];
echo $rate_133;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_133='$rate_133'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_133 ='$expiry_ticket_133'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_133 ='$ticket_133'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
