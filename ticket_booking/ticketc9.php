...
<?php
echo $expiry_ticket_c9 =$_GET['expiry_ticket_c9'];
echo $expiry =$_GET['expiry_ticket_c9'];
echo $ticket_c9 =$_GET['ticket_c9'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_c9'];
...
$rate_c9=$_GET['Class_three_rate'];
echo $rate_c9;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_c9='$rate_c9'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_c9 ='$expiry_ticket_c9'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_c9 ='$ticket_c9'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
