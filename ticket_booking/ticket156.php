...
<?php
echo $expiry_ticket_156 =$_GET['expiry_ticket_156'];
echo $expiry =$_GET['expiry_ticket_156'];
echo $ticket_156 =$_GET['ticket_156'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_156'];
...
$rate_156=$_GET['Class_three_rate'];
echo $rate_156;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_156='$rate_156'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_156 ='$expiry_ticket_156'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_156 ='$ticket_156'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
