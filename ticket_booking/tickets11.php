...
<?php
echo $expiry_ticket_s11 =$_GET['expiry_ticket_s11'];
echo $expiry =$_GET['expiry_ticket_s11'];
echo $ticket_s11 =$_GET['ticket_s11'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_s11'];
...
$rate_s11=$_GET['Class_three_rate'];
echo $rate_s11;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_s11='$rate_s11'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_s11 ='$expiry_ticket_s11'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_s11 ='$ticket_s11'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
