...
<?php
echo $expiry_ticket_b20 =$_GET['expiry_ticket_b20'];
echo $expiry =$_GET['expiry_ticket_b20'];
echo $ticket_b20 =$_GET['ticket_b20'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_b20'];
...
$rate_b20=$_GET['Class_three_rate'];
echo $rate_b20;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_b20='$rate_b20'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_b20 ='$expiry_ticket_b20'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_b20 ='$ticket_b20'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
