...
<?php
echo $expiry_ticket_b52 =$_GET['expiry_ticket_b52'];
echo $expiry =$_GET['expiry_ticket_b52'];
echo $ticket_b52 =$_GET['ticket_b52'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_b52'];
...
$rate_b52=$_GET['Class_three_rate'];
echo $rate_b52;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_b52='$rate_b52'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_b52 ='$expiry_ticket_b52'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_b52 ='$ticket_b52'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
