...
<?php
echo $expiry_ticket_e13 =$_GET['expiry_ticket_e13'];
echo $expiry =$_GET['expiry_ticket_e13'];
echo $ticket_e13 =$_GET['ticket_e13'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_e13'];
...
$rate_e13=$_GET['Class_three_rate'];
echo $rate_e13;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_e13='$rate_e13'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_e13 ='$expiry_ticket_e13'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_e13 ='$ticket_e13'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
