...
<?php
echo $expiry_ticket_s10 =$_GET['expiry_ticket_s10'];
echo $expiry =$_GET['expiry_ticket_s10'];
echo $ticket_s10 =$_GET['ticket_s10'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_s10'];
...
$rate_s10=$_GET['Class_three_rate'];
echo $rate_s10;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_s10='$rate_s10'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_s10 ='$expiry_ticket_s10'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_s10 ='$ticket_s10'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
