...
<?php
echo $expiry_ticket_142 =$_GET['expiry_ticket_142'];
echo $expiry =$_GET['expiry_ticket_142'];
echo $ticket_142 =$_GET['ticket_142'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_142'];
...
$rate_142=$_GET['Class_three_rate'];
echo $rate_142;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_142='$rate_142'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_142 ='$expiry_ticket_142'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_142 ='$ticket_142'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
