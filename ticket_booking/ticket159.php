...
<?php
echo $expiry_ticket_159 =$_GET['expiry_ticket_159'];
echo $expiry =$_GET['expiry_ticket_159'];
echo $ticket_159 =$_GET['ticket_159'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_159'];
...
$rate_159=$_GET['Class_three_rate'];
echo $rate_159;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_159='$rate_159'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_159 ='$expiry_ticket_159'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_159 ='$ticket_159'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
