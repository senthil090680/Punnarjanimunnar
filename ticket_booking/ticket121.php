...
<?php
echo $expiry_ticket_121 =$_GET['expiry_ticket_121'];
echo $expiry =$_GET['expiry_ticket_121'];
echo $ticket_121 =$_GET['ticket_121'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_121'];
...
$rate_121=$_GET['Class_three_rate'];
echo $rate_121;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_121='$rate_121'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_121 ='$expiry_ticket_121'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_121 ='$ticket_121'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
