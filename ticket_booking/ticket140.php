...
<?php
echo $expiry_ticket_140 =$_GET['expiry_ticket_140'];
echo $expiry =$_GET['expiry_ticket_140'];
echo $ticket_140 =$_GET['ticket_140'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_140'];
...
$rate_140=$_GET['Class_three_rate'];
echo $rate_140;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_140='$rate_140'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_140 ='$expiry_ticket_140'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_140 ='$ticket_140'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
