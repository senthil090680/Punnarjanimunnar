...
<?php
echo $expiry_ticket_e2 =$_GET['expiry_ticket_e2'];
echo $expiry =$_GET['expiry_ticket_e2'];
echo $ticket_e2 =$_GET['ticket_e2'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_e2'];
...
$rate_e2=$_GET['Class_three_rate'];
echo $rate_e2;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_e2='$rate_e2'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_e2 ='$expiry_ticket_e2'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_e2 ='$ticket_e2'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
