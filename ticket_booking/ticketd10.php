...
<?php
echo $expiry_ticket_d10 =$_GET['expiry_ticket_d10'];
echo $expiry =$_GET['expiry_ticket_d10'];
echo $ticket_d10 =$_GET['ticket_d10'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_d10'];
...
$rate_d10=$_GET['Class_three_rate'];
echo $rate_d10;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_d10='$rate_d10'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_d10 ='$expiry_ticket_d10'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_d10 ='$ticket_d10'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
