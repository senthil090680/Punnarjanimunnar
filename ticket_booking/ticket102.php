...
<?php
echo $expiry_ticket_102 =$_GET['expiry_ticket_102'];
echo $expiry =$_GET['expiry_ticket_102'];
echo $ticket_102 =$_GET['ticket_102'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_102'];
...
$rate_102=$_GET['Class_three_rate'];
echo $rate_102;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_102='$rate_102'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_102 ='$expiry_ticket_102'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_102 ='$ticket_102'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
