...
<?php
echo $expiry_ticket_c54 =$_GET['expiry_ticket_c54'];
echo $expiry =$_GET['expiry_ticket_c54'];
echo $ticket_c54 =$_GET['ticket_c54'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_c54'];
...
$rate_c54=$_GET['Class_three_rate'];
echo $rate_c54;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_c54='$rate_c54'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_c54 ='$expiry_ticket_c54'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_c54 ='$ticket_c54'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
