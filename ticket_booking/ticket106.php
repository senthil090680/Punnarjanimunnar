...
<?php
echo $expiry_ticket_106 =$_GET['expiry_ticket_106'];
echo $expiry =$_GET['expiry_ticket_106'];
echo $ticket_106 =$_GET['ticket_106'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_106'];
...
$rate_106=$_GET['Class_three_rate'];
echo $rate_106;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_106='$rate_106'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_106 ='$expiry_ticket_106'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_106 ='$ticket_106'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
