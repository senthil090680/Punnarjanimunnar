...
<?php
echo $expiry_ticket_125 =$_GET['expiry_ticket_125'];
echo $expiry =$_GET['expiry_ticket_125'];
echo $ticket_125 =$_GET['ticket_125'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_125'];
...
$rate_125=$_GET['Class_three_rate'];
echo $rate_125;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_125='$rate_125'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_125 ='$expiry_ticket_125'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_125 ='$ticket_125'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
