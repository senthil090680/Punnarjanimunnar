...
<?php
echo $expiry_ticket_153 =$_GET['expiry_ticket_153'];
echo $expiry =$_GET['expiry_ticket_153'];
echo $ticket_153 =$_GET['ticket_153'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_153'];
...
$rate_153=$_GET['Class_three_rate'];
echo $rate_153;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_153='$rate_153'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_153 ='$expiry_ticket_153'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_153 ='$ticket_153'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
