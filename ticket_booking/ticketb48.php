...
<?php
echo $expiry_ticket_b48 =$_GET['expiry_ticket_b48'];
echo $expiry =$_GET['expiry_ticket_b48'];
echo $ticket_b48 =$_GET['ticket_b48'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_b48'];
...
$rate_b48=$_GET['Class_three_rate'];
echo $rate_b48;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_b48='$rate_b48'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_b48 ='$expiry_ticket_b48'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_b48 ='$ticket_b48'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
