...
<?php
echo $expiry_ticket_u17 =$_GET['expiry_ticket_u17'];
echo $expiry =$_GET['expiry_ticket_u17'];
echo $ticket_u17 =$_GET['ticket_u17'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_u17'];
...
$rate_u17=$_GET['Class_three_rate'];
echo $rate_u17;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_u17='$rate_u17'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_u17 ='$expiry_ticket_u17'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_u17 ='$ticket_u17'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
