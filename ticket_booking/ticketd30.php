...
<?php
echo $expiry_ticket_d30 =$_GET['expiry_ticket_d30'];
echo $expiry =$_GET['expiry_ticket_d30'];
echo $ticket_d30 =$_GET['ticket_d30'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_d30'];
...
$rate_d30=$_GET['Class_three_rate'];
echo $rate_d30;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_d30='$rate_d30'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_d30 ='$expiry_ticket_d30'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_d30 ='$ticket_d30'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
