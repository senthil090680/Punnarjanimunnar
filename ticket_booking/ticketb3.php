...
<?php
echo $expiry_ticket_b3 =$_GET['expiry_ticket_b3'];
echo $expiry =$_GET['expiry_ticket_b3'];
echo $ticket_b3 =$_GET['ticket_b3'];
...
$rate_b3=$_GET['Class_three_rate'];
echo $rate_b3;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_b3='$rate_b3'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_b3 ='$expiry_ticket_b3'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_b3 ='$ticket_b3'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
