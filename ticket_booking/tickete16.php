...
<?php
echo $expiry_ticket_e16 =$_GET['expiry_ticket_e16'];
echo $expiry =$_GET['expiry_ticket_e16'];
echo $ticket_e16 =$_GET['ticket_e16'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_e16'];
...
$rate_e16=$_GET['Class_three_rate'];
echo $rate_e16;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_e16='$rate_e16'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_e16 ='$expiry_ticket_e16'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_e16 ='$ticket_e16'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
