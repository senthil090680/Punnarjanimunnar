...
<?php
echo $expiry_ticket_f11 =$_GET['expiry_ticket_f11'];
echo $expiry =$_GET['expiry_ticket_f11'];
echo $ticket_f11 =$_GET['ticket_f11'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_f11'];
...
$rate_f11=$_GET['Class_three_rate'];
echo $rate_f11;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_f11='$rate_f11'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_f11 ='$expiry_ticket_f11'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_f11 ='$ticket_f11'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
