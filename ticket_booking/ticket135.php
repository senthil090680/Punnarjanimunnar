...
<?php
echo $expiry_ticket_135 =$_GET['expiry_ticket_135'];
echo $expiry =$_GET['expiry_ticket_135'];
echo $ticket_135 =$_GET['ticket_135'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_135'];
...
$rate_135=$_GET['Class_three_rate'];
echo $rate_135;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_135='$rate_135'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_135 ='$expiry_ticket_135'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_135 ='$ticket_135'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
