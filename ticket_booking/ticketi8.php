...
<?php
echo $expiry_ticket_i8 =$_GET['expiry_ticket_i8'];
echo $expiry =$_GET['expiry_ticket_i8'];
echo $ticket_i8 =$_GET['ticket_i8'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_i8'];
...
$rate_i8=$_GET['Class_three_rate'];
echo $rate_i8;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_i8='$rate_i8'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_i8 ='$expiry_ticket_i8'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_i8 ='$ticket_i8'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
