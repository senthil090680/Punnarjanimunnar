...
<?php
echo $expiry_ticket_147 =$_GET['expiry_ticket_147'];
echo $expiry =$_GET['expiry_ticket_147'];
echo $ticket_147 =$_GET['ticket_147'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_147'];
...
$rate_147=$_GET['Class_three_rate'];
echo $rate_147;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_147='$rate_147'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_147 ='$expiry_ticket_147'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_147 ='$ticket_147'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
