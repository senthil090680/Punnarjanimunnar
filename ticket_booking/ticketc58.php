...
<?php
echo $expiry_ticket_c58 =$_GET['expiry_ticket_c58'];
echo $expiry =$_GET['expiry_ticket_c58'];
echo $ticket_c58 =$_GET['ticket_c58'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_c58'];
...
$rate_c58=$_GET['Class_three_rate'];
echo $rate_c58;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_c58='$rate_c58'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_c58 ='$expiry_ticket_c58'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_c58 ='$ticket_c58'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
