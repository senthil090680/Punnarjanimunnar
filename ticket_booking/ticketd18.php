...
<?php
echo $expiry_ticket_d18 =$_GET['expiry_ticket_d18'];
echo $expiry =$_GET['expiry_ticket_d18'];
echo $ticket_d18 =$_GET['ticket_d18'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_d18'];
...
$rate_d18=$_GET['Class_three_rate'];
echo $rate_d18;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_d18='$rate_d18'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_d18 ='$expiry_ticket_d18'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_d18 ='$ticket_d18'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
