...
<?php
echo $expiry_ticket_160 =$_GET['expiry_ticket_160'];
echo $expiry =$_GET['expiry_ticket_160'];
echo $ticket_160 =$_GET['ticket_160'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_160'];
...
$rate_160=$_GET['Class_three_rate'];
echo $rate_160;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_160='$rate_160'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_160 ='$expiry_ticket_160'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_160 ='$ticket_160'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
