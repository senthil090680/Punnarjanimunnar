...
<?php
echo $expiry_ticket_146 =$_GET['expiry_ticket_146'];
echo $expiry =$_GET['expiry_ticket_146'];
echo $ticket_146 =$_GET['ticket_146'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_146'];
...
$rate_146=$_GET['Class_three_rate'];
echo $rate_146;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_146='$rate_146'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_146 ='$expiry_ticket_146'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_146 ='$ticket_146'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
