...
<?php
echo $expiry_ticket_s9 =$_GET['expiry_ticket_s9'];
echo $expiry =$_GET['expiry_ticket_s9'];
echo $ticket_s9 =$_GET['ticket_s9'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_s9'];
...
$rate_s9=$_GET['Class_three_rate'];
echo $rate_s9;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_s9='$rate_s9'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_s9 ='$expiry_ticket_s9'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_s9 ='$ticket_s9'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
