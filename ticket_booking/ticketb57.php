...
<?php
echo $expiry_ticket_b57 =$_GET['expiry_ticket_b57'];
echo $expiry =$_GET['expiry_ticket_b57'];
echo $ticket_b57 =$_GET['ticket_b57'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_b57'];
...
$rate_b57=$_GET['Class_three_rate'];
echo $rate_b57;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_b57='$rate_b57'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_b57 ='$expiry_ticket_b57'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_b57 ='$ticket_b57'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
