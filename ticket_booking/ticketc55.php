...
<?php
echo $expiry_ticket_c55 =$_GET['expiry_ticket_c55'];
echo $expiry =$_GET['expiry_ticket_c55'];
echo $ticket_c55 =$_GET['ticket_c55'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_c55'];
...
$rate_c55=$_GET['Class_three_rate'];
echo $rate_c55;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_c55='$rate_c55'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_c55 ='$expiry_ticket_c55'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_c55 ='$ticket_c55'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
