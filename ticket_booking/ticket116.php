...
<?php
echo $expiry_ticket_116 =$_GET['expiry_ticket_116'];
echo $expiry =$_GET['expiry_ticket_116'];
echo $ticket_116 =$_GET['ticket_116'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_116'];
...
$rate_116=$_GET['Class_three_rate'];
echo $rate_116;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_116='$rate_116'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_116 ='$expiry_ticket_116'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_116 ='$ticket_116'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
