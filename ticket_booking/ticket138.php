...
<?php
echo $expiry_ticket_138 =$_GET['expiry_ticket_138'];
echo $expiry =$_GET['expiry_ticket_138'];
echo $ticket_138 =$_GET['ticket_138'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_138'];
...
$rate_138=$_GET['Class_three_rate'];
echo $rate_138;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_138='$rate_138'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_138 ='$expiry_ticket_138'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_138 ='$ticket_138'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
