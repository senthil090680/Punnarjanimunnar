...
<?php
echo $expiry_ticket_c51 =$_GET['expiry_ticket_c51'];
echo $expiry =$_GET['expiry_ticket_c51'];
echo $ticket_c51 =$_GET['ticket_c51'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_c51'];
...
$rate_c51=$_GET['Class_three_rate'];
echo $rate_c51;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_c51='$rate_c51'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_c51 ='$expiry_ticket_c51'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_c51 ='$ticket_c51'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
