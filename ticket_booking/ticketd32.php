...
<?php
echo $expiry_ticket_d32 =$_GET['expiry_ticket_d32'];
echo $expiry =$_GET['expiry_ticket_d32'];
echo $ticket_d32 =$_GET['ticket_d32'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_d32'];
...
$rate_d32=$_GET['Class_three_rate'];
echo $rate_d32;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_d32='$rate_d32'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_d32 ='$expiry_ticket_d32'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_d32 ='$ticket_d32'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
