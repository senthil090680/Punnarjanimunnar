...
<?php
echo $expiry_ticket_a16 =$_GET['expiry_ticket_a16'];
echo $expiry =$_GET['expiry_ticket_a16'];
echo $ticket_a16 =$_GET['ticket_a16'];
...
$rate_a16=$_GET['Class_three_rate'];
echo $rate_a16;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_a16='$rate_a16'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_a16 ='$expiry_ticket_a16'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_a16 ='$ticket_a16'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
