...
<?php
echo $expiry_ticket_b27 =$_GET['expiry_ticket_b27'];
echo $expiry =$_GET['expiry_ticket_b27'];
echo $ticket_b27 =$_GET['ticket_b27'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_b27'];
...
$rate_b27=$_GET['Class_three_rate'];
echo $rate_b27;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_b27='$rate_b27'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_b27 ='$expiry_ticket_b27'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_b27 ='$ticket_b27'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
