...
<?php
echo $expiry_ticket_145 =$_GET['expiry_ticket_145'];
echo $expiry =$_GET['expiry_ticket_145'];
echo $ticket_145 =$_GET['ticket_145'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_145'];
...
$rate_145=$_GET['Class_three_rate'];
echo $rate_145;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_145='$rate_145'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_145 ='$expiry_ticket_145'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_145 ='$ticket_145'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
