...
<?php
echo $expiry_ticket_c39 =$_GET['expiry_ticket_c39'];
echo $expiry =$_GET['expiry_ticket_c39'];
echo $ticket_c39 =$_GET['ticket_c39'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_c39'];
...
$rate_c39=$_GET['Class_three_rate'];
echo $rate_c39;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_c39='$rate_c39'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_c39 ='$expiry_ticket_c39'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_c39 ='$ticket_c39'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
