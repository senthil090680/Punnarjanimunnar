...
<?php
echo $expiry_ticket_137 =$_GET['expiry_ticket_137'];
echo $expiry =$_GET['expiry_ticket_137'];
echo $ticket_137 =$_GET['ticket_137'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_137'];
...
$rate_137=$_GET['Class_three_rate'];
echo $rate_137;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_137='$rate_137'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_137 ='$expiry_ticket_137'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_137 ='$ticket_137'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
