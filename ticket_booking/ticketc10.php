...
<?php
echo $expiry_ticket_c10 =$_GET['expiry_ticket_c10'];
echo $expiry =$_GET['expiry_ticket_c10'];
echo $ticket_c10 =$_GET['ticket_c10'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_c10'];
...
$rate_c10=$_GET['Class_three_rate'];
echo $rate_c10;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_c10='$rate_c10'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_c10 ='$expiry_ticket_c10'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_c10 ='$ticket_c10'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
