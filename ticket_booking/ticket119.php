...
<?php
echo $expiry_ticket_119 =$_GET['expiry_ticket_119'];
echo $expiry =$_GET['expiry_ticket_119'];
echo $ticket_119 =$_GET['ticket_119'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_119'];
...
$rate_119=$_GET['Class_three_rate'];
echo $rate_119;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_119='$rate_119'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_119 ='$expiry_ticket_119'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_119 ='$ticket_119'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
