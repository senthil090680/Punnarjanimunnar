...
<?php
echo $expiry_ticket_c17 =$_GET['expiry_ticket_c17'];
echo $expiry =$_GET['expiry_ticket_c17'];
echo $ticket_c17 =$_GET['ticket_c17'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_c17'];
...
$rate_c17=$_GET['Class_three_rate'];
echo $rate_c17;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_c17='$rate_c17'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_c17 ='$expiry_ticket_c17'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_c17 ='$ticket_c17'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
