...
<?php
echo $expiry_ticket_d36 =$_GET['expiry_ticket_d36'];
echo $expiry =$_GET['expiry_ticket_d36'];
echo $ticket_d36 =$_GET['ticket_d36'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_d36'];
...
$rate_d36=$_GET['Class_three_rate'];
echo $rate_d36;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_d36='$rate_d36'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_d36 ='$expiry_ticket_d36'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_d36 ='$ticket_d36'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
