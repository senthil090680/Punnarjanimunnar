...
<?php
echo $expiry_ticket_126 =$_GET['expiry_ticket_126'];
echo $expiry =$_GET['expiry_ticket_126'];
echo $ticket_126 =$_GET['ticket_126'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_126'];
...
$rate_126=$_GET['Class_three_rate'];
echo $rate_126;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_126='$rate_126'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_126 ='$expiry_ticket_126'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_126 ='$ticket_126'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
