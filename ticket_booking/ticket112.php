...
<?php
echo $expiry_ticket_112 =$_GET['expiry_ticket_112'];
echo $expiry =$_GET['expiry_ticket_112'];
echo $ticket_112 =$_GET['ticket_112'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_112'];
...
$rate_112=$_GET['Class_three_rate'];
echo $rate_112;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_112='$rate_112'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_112 ='$expiry_ticket_112'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_112 ='$ticket_112'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
