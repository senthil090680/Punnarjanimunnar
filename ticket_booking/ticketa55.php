...
<?php
echo $expiry_ticket_a55 =$_GET['expiry_ticket_a55'];
echo $expiry =$_GET['expiry_ticket_a55'];
echo $ticket_a55 =$_GET['ticket_a55'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_a55'];
...
$rate_a55=$_GET['Class_three_rate'];
echo $rate_a55;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_a55='$rate_a55'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_a55 ='$expiry_ticket_a55'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_a55 ='$ticket_a55'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
