...
<?php
echo $expiry_ticket_101 =$_GET['expiry_ticket_101'];
echo $expiry =$_GET['expiry_ticket_101'];
echo $ticket_101 =$_GET['ticket_101'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_101'];
...
$rate_101=$_GET['Class_three_rate'];
echo $rate_101;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_101='$rate_101'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_101 ='$expiry_ticket_101'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_101 ='$ticket_101'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
