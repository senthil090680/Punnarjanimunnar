...
<?php
echo $expiry_ticket_s2 =$_GET['expiry_ticket_s2'];
echo $expiry =$_GET['expiry_ticket_s2'];
echo $ticket_s2 =$_GET['ticket_s2'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_s2'];
...
$rate_s2=$_GET['Class_three_rate'];
echo $rate_s2;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_s2='$rate_s2'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_s2 ='$expiry_ticket_s2'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_s2 ='$ticket_s2'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
