...
<?php
echo $expiry_ticket_d38 =$_GET['expiry_ticket_d38'];
echo $expiry =$_GET['expiry_ticket_d38'];
echo $ticket_d38 =$_GET['ticket_d38'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_d38'];
...
$rate_d38=$_GET['Class_three_rate'];
echo $rate_d38;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_d38='$rate_d38'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_d38 ='$expiry_ticket_d38'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_d38 ='$ticket_d38'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
