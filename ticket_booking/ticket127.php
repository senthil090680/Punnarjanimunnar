...
<?php
echo $expiry_ticket_127 =$_GET['expiry_ticket_127'];
echo $expiry =$_GET['expiry_ticket_127'];
echo $ticket_127 =$_GET['ticket_127'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_127'];
...
$rate_127=$_GET['Class_three_rate'];
echo $rate_127;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_127='$rate_127'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_127 ='$expiry_ticket_127'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_127 ='$ticket_127'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
