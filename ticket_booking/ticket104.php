...
<?php
echo $expiry_ticket_104 =$_GET['expiry_ticket_104'];
echo $expiry =$_GET['expiry_ticket_104'];
echo $ticket_104 =$_GET['ticket_104'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_104'];
...
$rate_104=$_GET['Class_three_rate'];
echo $rate_104;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_104='$rate_104'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_104 ='$expiry_ticket_104'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_104 ='$ticket_104'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
