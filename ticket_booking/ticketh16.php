...
<?php
echo $expiry_ticket_h16 =$_GET['expiry_ticket_h16'];
echo $expiry =$_GET['expiry_ticket_h16'];
echo $ticket_h16 =$_GET['ticket_h16'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_h16'];
...
$rate_h16=$_GET['Class_three_rate'];
echo $rate_h16;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_h16='$rate_h16'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_h16 ='$expiry_ticket_h16'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_h16 ='$ticket_h16'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
