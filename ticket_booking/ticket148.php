...
<?php
echo $expiry_ticket_148 =$_GET['expiry_ticket_148'];
echo $expiry =$_GET['expiry_ticket_148'];
echo $ticket_148 =$_GET['ticket_148'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_148'];
...
$rate_148=$_GET['Class_three_rate'];
echo $rate_148;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_148='$rate_148'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_148 ='$expiry_ticket_148'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_148 ='$ticket_148'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
