...
<?php
echo $expiry_ticket_h8 =$_GET['expiry_ticket_h8'];
echo $expiry =$_GET['expiry_ticket_h8'];
echo $ticket_h8 =$_GET['ticket_h8'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_h8'];
...
$rate_h8=$_GET['Class_three_rate'];
echo $rate_h8;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_h8='$rate_h8'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_h8 ='$expiry_ticket_h8'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_h8 ='$ticket_h8'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
