...
<?php
echo $expiry_ticket_i14 =$_GET['expiry_ticket_i14'];
echo $expiry =$_GET['expiry_ticket_i14'];
echo $ticket_i14 =$_GET['ticket_i14'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_i14'];
...
$rate_i14=$_GET['Class_three_rate'];
echo $rate_i14;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_i14='$rate_i14'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_i14 ='$expiry_ticket_i14'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_i14 ='$ticket_i14'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
