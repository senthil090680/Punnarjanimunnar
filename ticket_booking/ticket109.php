...
<?php
echo $expiry_ticket_109 =$_GET['expiry_ticket_109'];
echo $expiry =$_GET['expiry_ticket_109'];
echo $ticket_109 =$_GET['ticket_109'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_109'];
...
$rate_109=$_GET['Class_three_rate'];
echo $rate_109;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_109='$rate_109'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_109 ='$expiry_ticket_109'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_109 ='$ticket_109'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
