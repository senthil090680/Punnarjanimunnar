...
<?php
echo $expiry_ticket_b51 =$_GET['expiry_ticket_b51'];
echo $expiry =$_GET['expiry_ticket_b51'];
echo $ticket_b51 =$_GET['ticket_b51'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_b51'];
...
$rate_b51=$_GET['Class_three_rate'];
echo $rate_b51;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_b51='$rate_b51'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_b51 ='$expiry_ticket_b51'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_b51 ='$ticket_b51'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
