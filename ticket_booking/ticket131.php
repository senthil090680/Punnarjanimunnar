...
<?php
echo $expiry_ticket_131 =$_GET['expiry_ticket_131'];
echo $expiry =$_GET['expiry_ticket_131'];
echo $ticket_131 =$_GET['ticket_131'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_131'];
...
$rate_131=$_GET['Class_three_rate'];
echo $rate_131;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_131='$rate_131'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_131 ='$expiry_ticket_131'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_131 ='$ticket_131'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
