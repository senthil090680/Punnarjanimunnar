...
<?php
echo $expiry_ticket_105 =$_GET['expiry_ticket_105'];
echo $expiry =$_GET['expiry_ticket_105'];
echo $ticket_105 =$_GET['ticket_105'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_105'];
...
$rate_105=$_GET['Class_three_rate'];
echo $rate_105;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_105='$rate_105'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_105 ='$expiry_ticket_105'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_105 ='$ticket_105'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
