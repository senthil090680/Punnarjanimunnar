...
<?php
echo $expiry_ticket_f12 =$_GET['expiry_ticket_f12'];
echo $expiry =$_GET['expiry_ticket_f12'];
echo $ticket_f12 =$_GET['ticket_f12'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_f12'];
...
$rate_f12=$_GET['Class_three_rate'];
echo $rate_f12;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_f12='$rate_f12'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_f12 ='$expiry_ticket_f12'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_f12 ='$ticket_f12'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
