...
<?php
echo $expiry_ticket_113 =$_GET['expiry_ticket_113'];
echo $expiry =$_GET['expiry_ticket_113'];
echo $ticket_113 =$_GET['ticket_113'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_113'];
...
$rate_113=$_GET['Class_three_rate'];
echo $rate_113;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_113='$rate_113'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_113 ='$expiry_ticket_113'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_113 ='$ticket_113'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
