...
<?php
echo $expiry_ticket_150 =$_GET['expiry_ticket_150'];
echo $expiry =$_GET['expiry_ticket_150'];
echo $ticket_150 =$_GET['ticket_150'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_150'];
...
$rate_150=$_GET['Class_three_rate'];
echo $rate_150;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_150='$rate_150'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_150 ='$expiry_ticket_150'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_150 ='$ticket_150'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
