...
<?php
echo $expiry_ticket_c52 =$_GET['expiry_ticket_c52'];
echo $expiry =$_GET['expiry_ticket_c52'];
echo $ticket_c52 =$_GET['ticket_c52'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_c52'];
...
$rate_c52=$_GET['Class_three_rate'];
echo $rate_c52;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_c52='$rate_c52'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_c52 ='$expiry_ticket_c52'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_c52 ='$ticket_c52'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
