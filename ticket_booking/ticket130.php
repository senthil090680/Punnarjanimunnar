...
<?php
echo $expiry_ticket_130 =$_GET['expiry_ticket_130'];
echo $expiry =$_GET['expiry_ticket_130'];
echo $ticket_130 =$_GET['ticket_130'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_130'];
...
$rate_130=$_GET['Class_three_rate'];
echo $rate_130;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_130='$rate_130'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_130 ='$expiry_ticket_130'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_130 ='$ticket_130'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
