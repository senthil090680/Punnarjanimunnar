...
<?php
echo $expiry_ticket_a52 =$_GET['expiry_ticket_a52'];
echo $expiry =$_GET['expiry_ticket_a52'];
echo $ticket_a52 =$_GET['ticket_a52'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_a52'];
...
$rate_a52=$_GET['Class_three_rate'];
echo $rate_a52;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_a52='$rate_a52'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_a52 ='$expiry_ticket_a52'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_a52 ='$ticket_a52'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
