...
echo $Class_two_rate;
$rate_a11=$_GET['Class_one_rate'];
echo $rate_a11;

$sql=mysql_query("UPDATE team_booking_details SET ticket_a11='$ticket_a11'
...
rate_a11='$rate_a11' WHERE  user_id='".$user_id."' ");
