...
$time=$_GET['time'];
echo $time;
$Class_two_rate=$_GET['Class_two_rate'];
echo $Class_two_rate;
$rate_a14=$_GET['Class_one_rate'];
echo $rate_a14;

$sql=mysql_query("UPDATE team_booking_details SET ticket_a14='$ticket_a14'
...
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET 
rate_a14='$rate_a14' WHERE  user_id='".$user_id."' ");
