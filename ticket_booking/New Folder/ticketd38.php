...
$time=$_GET['time'];
echo $time;
$rate_b4=$_GET['Class_one_rate'];
echo $rate_b4;

$sql=mysql_query("UPDATE team_booking_details SET ticket_b4='$ticket_b4'
...
rate_b4='$rate_b4' WHERE  user_id='".$user_id."' ");
