...
$time=$_GET['time'];
echo $time;
$rate_b7=$_GET['Class_one_rate'];
echo $rate_b7;



$sql=mysql_query("UPDATE team_booking_details SET ticket_b7='$ticket_b7'
...
rate_b7='$rate_b7' WHERE  user_id='".$user_id."' ");
