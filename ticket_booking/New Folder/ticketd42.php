...
$time=$_GET['time'];
echo $time;
$rate_b8=$_GET['Class_one_rate'];
echo $rate_b8;



$sql=mysql_query("UPDATE team_booking_details SET ticket_b8='$ticket_b8'
...
rate_b8='$rate_b8' WHERE  user_id='".$user_id."' ");
