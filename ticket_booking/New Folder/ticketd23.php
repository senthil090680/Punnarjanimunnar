...
$time=$_GET['time'];
echo $time;
$rate_a6=$_GET['Class_one_rate'];
echo $rate_a6;


$sql=mysql_query("UPDATE team_booking_details SET ticket_a6='$ticket_a6'
...
rate_a6='$rate_a6' WHERE  user_id='".$user_id."' ");
