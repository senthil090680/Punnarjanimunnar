...
$time=$_GET['time'];
echo $time;
$rate_a5=$_GET['Class_one_rate'];
echo $rate_a5;

$sql=mysql_query("UPDATE team_booking_details SET ticket_a5='$ticket_a5'
...
rate_a5='$rate_a5' WHERE  user_id='".$user_id."' ");
