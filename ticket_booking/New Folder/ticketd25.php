...
$time=$_GET['time'];
echo $time;
$rate_a8=$_GET['Class_one_rate'];
echo $rate_a8;



$sql=mysql_query("UPDATE team_booking_details SET ticket_a8='$ticket_a8'
...
rate_a8='$rate_a8' WHERE  user_id='".$user_id."' ");
