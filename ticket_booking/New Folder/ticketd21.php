...
$time=$_GET['time'];
echo $time;
$rate_a4=$_GET['Class_one_rate'];
echo $rate_a4;

$sql=mysql_query("UPDATE team_booking_details SET ticket_a4='$ticket_a4'
...
rate_a4='$rate_a4' WHERE  user_id='".$user_id."' ");
