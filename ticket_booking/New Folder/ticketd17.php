...
$time=$_GET['time'];
echo $time;
$rate_c4=$_GET['Class_one_rate'];
echo $rate_c4;

$sql=mysql_query("UPDATE team_booking_details SET ticket_c4='$ticket_c4'
...
rate_c4='$rate_c4' WHERE  user_id='".$user_id."' ");
