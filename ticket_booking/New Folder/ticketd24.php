...
$time=$_GET['time'];
echo $time;
$rate_a7=$_GET['Class_one_rate'];
echo $rate_a7;



$sql=mysql_query("UPDATE team_booking_details SET ticket_a7='$ticket_a7'
...
rate_a7='$rate_a7' WHERE  user_id='".$user_id."' ");
