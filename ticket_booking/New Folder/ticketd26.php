...
$time=$_GET['time'];
echo $time;
$rate_a9=$_GET['Class_one_rate'];
echo $rate_a9;



$sql=mysql_query("UPDATE team_booking_details SET ticket_a9='$ticket_a9'
...
rate_a9='$rate_a9' WHERE  user_id='".$user_id."' ");
