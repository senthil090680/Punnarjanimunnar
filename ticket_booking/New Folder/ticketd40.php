...
$time=$_GET['time'];
echo $time;
$rate_b6=$_GET['Class_one_rate'];
echo $rate_b6;


$sql=mysql_query("UPDATE team_booking_details SET ticket_b6='$ticket_b6'
...
rate_b6='$rate_b6' WHERE  user_id='".$user_id."' ");
