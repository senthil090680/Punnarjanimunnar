...
$time=$_GET['time'];
echo $time;
$rate_b5=$_GET['Class_one_rate'];
echo $rate_b5;

$sql=mysql_query("UPDATE team_booking_details SET ticket_b5='$ticket_b5'
...
rate_b5='$rate_b5' WHERE  user_id='".$user_id."' ");
