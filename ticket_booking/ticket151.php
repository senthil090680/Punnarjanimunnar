...
<?php
echo $expiry_ticket_151 =$_GET['expiry_ticket_151'];
echo $expiry =$_GET['expiry_ticket_151'];
echo $ticket_151 =$_GET['ticket_151'];

$user_id =$_GET['user_id'];
echo $user_id;
$email =$_GET['email'];
echo email;
$seat_no =$_GET['ticket_151'];
...
$rate_151=$_GET['Class_three_rate'];
echo $rate_151;
$sql_rate=mysql_query("UPDATE team_booked_ticket_rates SET rate_151='$rate_151'
WHERE  user_id='".$user_id."' ");


$sql=mysql_query("UPDATE team_booking_details SET  expiry_ticket_151 ='$expiry_ticket_151'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");

$sqls=mysql_query("UPDATE team_booking_details SET ticket_151 ='$ticket_151'
WHERE auditorium='".$auditorium."' and event='".$event."' and time='".$time."' ");
